...
| C9 | C8's shop, rebuilt — **done 2026-09-24**, see [the record](2026-09-24-acceptance-c9-dna-round2.md) | `dna init` killed mid-round, its store stashed away, then resumed in a new session | real `claude -p`, branch `feat/dna-round2` | the size-and-cap step, the Sonnet scanner against C8's Haiku (87% usable against 28%), and a restore-and-resume with nothing scanned twice |
