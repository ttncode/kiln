...
> Section 1 (v1 scope) and Sections A–H all locked. The decision log runs to **D162**. It reached D89 after five
...
> projects, and **D152–D162** from building the Knowledge tier (DNA) on branch `feat/dna`. Tier D is graded (`2026-09-21-acceptance-c6-handover.md`). What remains for a v1.0
