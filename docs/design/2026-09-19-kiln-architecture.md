...
> Section 1 (v1 scope) and Sections A–H all locked. The decision log runs to **D174**. It reached D89 after five
...
> projects, and **D152–D169** from building the Knowledge tier (DNA) on branch `feat/dna`, and **D170–D174** from its first real bootstrap. Tier D is graded (`2026-09-21-acceptance-c6-handover.md`). What remains for a v1.0
