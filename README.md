...
| | |
|---|---|
| Tests | 633, plus one case per row of the guard corpus; green on every pull request |
...
| File | Holds |
|---|---|
| [`kiln-architecture.md`](docs/design/2026-09-19-kiln-architecture.md) | the durable state — scope, sections A–H, and 174 decisions with their rationale |
