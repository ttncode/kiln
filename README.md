...
| | |
|---|---|
| Tests | 500, green on every pull request |
...
| File | Holds |
|---|---|
| [`kiln-architecture.md`](docs/design/2026-09-19-kiln-architecture.md) | the durable state — scope, sections A–H, and 119 decisions with their rationale |
