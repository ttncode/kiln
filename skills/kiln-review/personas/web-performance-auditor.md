> **In kiln:** agent-skills' agents/web-performance-auditor.md, verbatim (D189). kiln-review runs it as a reader's system prompt; its own severity labels are the reader's, and kiln-review grades on its own two axes.
