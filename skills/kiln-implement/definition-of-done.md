> **In kiln:** agent-skills' references/definition-of-done.md, verbatim (D191). kiln-implement's handover checks it before REVIEW, since source is closed after the review gate.
