> **In kiln:** agent-skills' skills/browser-testing-with-devtools/SKILL.md, verbatim (D189). A skill it names is the file of that name in kiln's skills; a path it gives (references/…) is the file of that name there too. What kiln overrides in it is said where kiln routes it.
