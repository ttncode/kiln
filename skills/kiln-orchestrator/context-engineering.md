> **In kiln:** agent-skills' skills/context-engineering/SKILL.md, verbatim (D192). Much of it kiln does in code — the state file and resume, fetched text as data, the DNA and blast map; read it for rules files and for loading context by task. A project rule is added with `kiln rules add`.
