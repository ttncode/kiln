...
const GATES = [conservation, identity, references, descriptions, provenance, plannedFeatures, plannedSurfaces, plannedFindings, debts, infra, edgeKinds, actors, ruleBuckets, components, reachability, stamp];
