/**
 * The id schemes of tps-project-dna `references/id-schemes.md`: ids nest under their parent and
 * count rather than hash. The next number follows the highest one the store holds or names in
 * its provenance, so a gap stays a gap and a merged-away id is not handed out again.
 */

const WIDTH = Object.freeze({ finding: 4, dated: 2, capability: 2, feature: 2, flow: 2, stage: 1, process: 1, excluded: 3 });
...
function childScheme(entity, record) {
  ...
  // id-schemes.md gives the excluded appendix no scheme; kiln counts one so a clustering batch
  // can put a finding there without inventing a name.
  if (entity === "excluded") return { prefix: "EXC-", width: WIDTH.excluded };
