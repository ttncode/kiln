...
export function gatherFacts(root, { config, state, stage, predicted = [] }) {
  ...
  const facts = { path: state.path, auto: state.auto === true, flags: flagsOf(root, state), files, lines: null, added: null, kinds: kindsOf(root, { config, files }) };
